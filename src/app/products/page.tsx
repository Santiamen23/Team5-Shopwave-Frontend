  ...
  return (
    <main className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <Card className="mb-8 overflow-hidden border-slate-200/70 bg-white/95">
        <CardHeader className="space-y-3 border-b border-slate-200/60 bg-gradient-to-r from-slate-950 to-slate-800 text-white">
          <CardTitle className="text-3xl sm:text-4xl">Catálogo de productos</CardTitle>
