    ...
    <div className={cn("space-y-3", wrapperClassName)}>
      ...
      <div className="relative">
        ...
        <input
          ...
          type="search"
          className={cn(
            "h-12 w-full rounded-2xl border border-slate-200 bg-white pl-11 pr-4 text-sm text-slate-900 outline-none transition focus:border-slate-400 focus:ring-2 focus:ring-slate-200",
            className,
          )}
          {...props}
        />
